...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dbfb4bda454adfded475e35419dec11cafd02ef80c22a5f8cc5a6d1d45c66f23.js',function(){input.required=false;search();});}
