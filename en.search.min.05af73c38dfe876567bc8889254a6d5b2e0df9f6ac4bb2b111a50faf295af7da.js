...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.82daacfdabd74fcb02363c9bf66a6ade9d9a17ba75557d3d549444d1f92afb43.js',function(){input.required=false;search();});}
