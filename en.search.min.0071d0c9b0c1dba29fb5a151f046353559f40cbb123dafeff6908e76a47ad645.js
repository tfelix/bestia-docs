...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6d7f4429ee765281912028a6279a52c9b2b47e5a4e718cd8aca87ae7892df19b.js',function(){input.required=false;search();});}
